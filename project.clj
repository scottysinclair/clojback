(defproject clojback "0.0.1-SNAPSHOT"
...
;;        "/home/scott/.m2/repository/scott/scott.barleydb/0.0.1-SNAPSHOT/scott.barleydb-0.0.1-SNAPSHOT.jar",
  ...
  :profiles {:dev {:aliases {"run-dev" ["trampoline" "run" "-m" "clojback.server/run-dev"]}
                   :dependencies [[io.pedestal/pedestal.service-tools "0.5.5"]]}
             :uberjar {:aot [clojback.server]}}
  :main ^{:skip-aot true} clojback.server)
